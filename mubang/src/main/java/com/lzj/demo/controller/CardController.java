...
public class CardController {
    ...
    private Map<String,Object> insertCard(@RequestBody(required = false) Card card){
        Map<String,Object> modelMap = new HashMap<>();
        modelMap.put("success",cardService.insertCard(card));
        return modelMap;
    }
    @RequestMapping(value = "/updatecard",method = RequestMethod.POST)
    private Map<String,Object> updateCard(@RequestBody(required = false) Card card){
        Map<String,Object> modelMap = new HashMap<>();
        modelMap.put("success",cardService.updateCard(card));
        return modelMap;
    }
    @RequestMapping(value = "/deletecard",method = RequestMethod.POST)
    private Map<String,Object> deleteCard(@RequestBody(required = false) Card card){
        Map<String,Object> modelMap = new HashMap<>();
